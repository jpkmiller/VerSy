...
public class AquaGui extends JFrame implements Runnable, Observer {
	...
	public AquaGui(final client.TankModel tankModel) {
		client.TankView tankView = new client.TankView(tankModel);
		...
		gsMenuItem.addActionListener(new client.NotImplementedYetController(this));
		...
		updateRunnable = new Runnable() {
			...
			public void run() {
				...
				while (tankModel.getFishCounter() > size) {
					...
					fishMenuItem.addActionListener(new client.NotImplementedYetController(AquaGui.this));
